...
namespace eShop.Catalog.Migrations
{
    ...
    [Migration("20230908140901_ProductsTableDiscountColumnAdded")]
    partial class ProductsTableDiscountColumnAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eShop.Catalog.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 9, 8, 14, 9, 1, 458, DateTimeKind.Unspecified).AddTicks(7837), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "UAH"
                        },
                        new
                        {
                            Id = new Guid("bf879fb6-7b4b-41c7-9cc5-df8724d511e5"),
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 9, 8, 14, 9, 1, 458, DateTimeKind.Unspecified).AddTicks(7840), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "USD"
                        },
                        new
                        {
                            Id = new Guid("41ed0945-7196-4ead-8f5e-db262e62e536"),
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 9, 8, 14, 9, 1, 458, DateTimeKind.Unspecified).AddTicks(7842), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "EUR"
                        });
                });
            ...
            modelBuilder.Entity("eShop.Catalog.Entities.Shop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 9, 8, 14, 9, 1, 458, DateTimeKind.Unspecified).AddTicks(7660), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Nike"
                        },
                        new
                        {
                            Id = new Guid("17a27ec2-eb71-4de8-be81-734aeffd28f9"),
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 9, 8, 14, 9, 1, 458, DateTimeKind.Unspecified).AddTicks(7682), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Puma"
                        },
                        new
                        {
                            Id = new Guid("9afc47e2-3866-42f8-96db-1042800aafa7"),
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 9, 8, 14, 9, 1, 458, DateTimeKind.Unspecified).AddTicks(7684), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Adidas"
                        });
                });
