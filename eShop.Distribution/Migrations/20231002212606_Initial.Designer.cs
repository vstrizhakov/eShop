...
namespace eShop.Distribution.Migrations
{
    ...
    [Migration("20231002212606_Initial")]
            ...
            modelBuilder.Entity("eShop.Distribution.Entities.CurrencyRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 10, 2, 21, 26, 5, 917, DateTimeKind.Unspecified).AddTicks(4813), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 10, 2, 21, 26, 5, 917, DateTimeKind.Unspecified).AddTicks(4821), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 10, 2, 21, 26, 5, 917, DateTimeKind.Unspecified).AddTicks(4831), new TimeSpan(0, 0, 0, 0, 0)),
                            Rate = 0.027,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 10, 2, 21, 26, 5, 917, DateTimeKind.Unspecified).AddTicks(4834), new TimeSpan(0, 0, 0, 0, 0)),
                            Rate = 1.05,
                            SourceCurrencyId = new Guid("41ed0945-7196-4ead-8f5e-db262e62e536"),
                            TargetCurrencyId = new Guid("bf879fb6-7b4b-41c7-9cc5-df8724d511e5")
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 10, 2, 21, 26, 5, 917, DateTimeKind.Unspecified).AddTicks(4837), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 10, 2, 21, 26, 5, 917, DateTimeKind.Unspecified).AddTicks(4839), new TimeSpan(0, 0, 0, 0, 0)),
