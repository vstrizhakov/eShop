...
using eShopping.ViberBot.Framework.Extensions;
using MassTransit;
...
using eShopping.Viber.ViberBotFramework.Middlewares;
using eShopping.Viber.DbContexts;
using eShopping.Viber.Repositories;
using eShopping.Viber.ViberBotFramework;

namespace eShopping.Viber
{
