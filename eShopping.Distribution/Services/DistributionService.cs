...
namespace eShopping.Distribution.Services
{
    public class DistributionService : IDistributionService
    {
        ...
        public async Task<Entities.Distribution> CreateDistributionAsync(Guid announcerId, Messaging.Contracts.Announce composition)
        {
        ...
        private async Task<DistributionSettingsRecord> CreateHistoryRecord(Account account)
        {
