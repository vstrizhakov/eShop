                ...
                <Row>
                    <Col xs={5}>
                        <div style={{ height: 120 }} className="d-flex align-items-center justify-content-center">
                            <img src={mainImage} style={{ maxWidth: "100%", maxHeight: "100%" }} className="rounded" />
                        </div>
                    </Col>
                    <Col xs={7}>
                        <div className="d-flex flex-column h-100 w-100">
                            <strong className="fw-semibold text-body-emphasis">Анонс від {createdAtDatetime.getDate()}.{createdAtDatetime.getMonth() + 1}.{createdAtDatetime.getFullYear()}</strong>
