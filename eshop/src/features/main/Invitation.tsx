                ...
                <Card bg="primary-subtle" className="invitation-card shadow-sm">
                    <Card.Body className="d-flex gap-4 p-4 text-white">
                        <div>
                            ...
                            <h4 className="my-0 text-primary-emphasis">Володимир Стрижаков</h4>
                        </div>

                        <div className="d-flex gap-1 flex-column">
                            <Button variant="outline-light" target="_blank" href={invitation.telegram} className="d-flex gap-2 align-items-center">
                                <Telegram fill="currentColor" width="32px" />
                                <span className="fw-semibold">Telegram</span>
                            </Button>
                            <Button variant="outline-light" target="_blank" href={invitation.viber} className="d-flex gap-2 align-items-center">
